        ...
        return moderationService.isAbusive(content)
                .flatMap(abusive -> {
                    ...
                    if (isMention || isReplyToBot) {
                        ...
                        System.out.println("🎯 Bot mentioned or replied to!");
                        ...
                        return msg.getChannel()
                                ...
                                .doOnNext(resp -> System.out.println("✨ Generated response: " + resp))
                                .onErrorResume(err -> {
                                    System.out.println("❌ Error during generation: " + err.getMessage());
                                    err.printStackTrace();
                                    return Mono.just("Sorry, I couldn't process your request at the moment.");
                                })
